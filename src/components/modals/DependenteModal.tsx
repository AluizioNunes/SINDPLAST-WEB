...
import { createDependente, updateDependente } from '@/lib/services/dependenteService';
...
export default function DependenteModal({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (dependente) {
                await updateDependente(dependente.id, formData);
            } else {
                await createDependente(formData);
            }
