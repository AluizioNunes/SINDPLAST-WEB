...
import { getContasReceber, deleteContaReceber } from '@/lib/services/contaReceberService';
...
export default function ContasReceber() {
    ...
    const { data, isLoading } = useQuery({
        queryKey: ['contasReceber', page, search],
        queryFn: () => getContasReceber({ page, search, limit: 10 }),
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <Button onClick={() => { setSelectedContaReceber(null); setIsModalOpen(true); }}>
