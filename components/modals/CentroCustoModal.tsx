...
import { createCentroCusto, updateCentroCusto } from '@/app/actions/centroCustos';
...
export default function CentroCustoModal({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            let result;
            if (centroCusto) {
                result = await updateCentroCusto(centroCusto.id, formData);
            } else {
                result = await createCentroCusto(formData);
            }
