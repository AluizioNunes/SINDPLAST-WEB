...
import { createContaPagar, updateContaPagar } from '@/app/actions/contasPagar';
...
export default function ContaPagarModal({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            let result;
            if (contaPagar) {
                result = await updateContaPagar(contaPagar.id, formData);
            } else {
                result = await createContaPagar(formData);
            }
